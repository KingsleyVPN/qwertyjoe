...
servercert='Certificate:
    ...
    Signature Algorithm: sha256WithRSAEncryption
        Issuer: C=PH, ST=Camarines Sur, L=Bikol, O=LeakersVPN, OU=LeakersVPN, CN=leakers-vpn.ph/name=server/emailAddress=leakersvpn@gmail.com
        Validity
            Not Before: Apr 20 04:53:44 2018 GMT
            Not After : Apr 17 04:53:44 2028 GMT
        Subject: C=PH, ST=Camarines Sur, L=Bikol, O=LeakersVPN, OU=LeakersVPN, CN=leakers-vpn.ph/name=server/emailAddress=leakersvpn@gmail.com
